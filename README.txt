===================================================
How to install the Resources-utilization-viewer-Ruview-master (RUVIEW) to your local PC?
===================================================
Prerequisites:
	This RUVIEW application can be installed on Windows, Linux and MacOS.
	Before installing the RUVIEW application, you should have the following software on your local PC: 
...
Installation procedure:
	...
	2. In your web browser, go to: http://localhost/RUVIEW_folder/
		(change "RUVIEW_folder" above to the name of the folder you extracted the files into
		in step 1)
	3. You should see setup instructions in your browser and you should follow the steps mentioned.
	
=========================================================
How to install the RUVIEW application to your hosting server?
=========================================================
Prerequisites:
	This RUVIEW application can be installed on both Windows and Linux servers.
	Before installing the RUVIEW application, make sure your server has the following software: 
...
Installation procedure:
	1. Extract the contents of the zip file and upload them to a folder inside your document
		...
		http://www.karelia.com/sandvox/help/z/Document_Root.html )
	2. In your web browser, go to: http://your_server_address/RUVIEW_folder/
		(change "your_server_address" above to the actual domain name or IP address of your
		server, and change"RUVIEW_folder" to the name of the folder you uploaded the files to
		in step 1)
	3. You should see setup instructions in your browser and you should follow the steps mentioned.
